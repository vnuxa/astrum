...
function animations:new(starting_value, time, easing, repeat_amount, reverse, delay)
	...
	---Animates any number value, based on the animation's state.
	---@param false_value number # The value to go to when the `animation` is `false`
	---@param true_value number  # The value to go to when the `animation` is `true`
	...
	---@param false_table table # The table to go to when the `animation` is `false`
	---@param true_table table # The table to go to when the `animation` is `true`
